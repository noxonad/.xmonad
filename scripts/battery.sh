...
for i in $(seq 0 $len); do
  if [[ $i -eq $percentage && $orientation != "left" ]] || [[ $((len - i)) -eq $percentage && $orientation == "left" ]]; then
  ...
  elif [[ $i -lt $percentage && $orientation != "left" ]] || [[ $((len - i)) -lt $percentage && $orientation == "left" ]]; then
